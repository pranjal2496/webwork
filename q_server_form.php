...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO registration_3(`name`, `address`, `purpose`, `image`) VALUES ('$name', '$address', '$purpose', '$uploadFile')";
    ...
    <div style="height: 93vh;">
        ...
        <div class="queen container ">
            <div class="form-content">
                ...
                <form id="dataForm" action="q_server_form.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
