...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO registration_2(`name`, `description`, `panel`, `username`, `password`, `image`) VALUES ('$name', '$description', '$panel', '$username', '$password', '$uploadFile')";
    ...
    <div style="height: 93vh;">
        ...
        <div class="queen container ">
            <div class="form-content">
                ...
                <form id="dataForm" action="q_admin_form.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
