...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO registration_1(`name`, `url`, `username`, `password`, `image`) VALUES ('$name', '$url', '$username', '$password', '$uploadFile')";
    ...
    <div style="height: 93vh;">
        ...
        <div class="queen container ">
            <div class="form-content">
                ...
                <form id="dataForm" action="q_web_form.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
