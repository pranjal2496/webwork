                ...
                <div class="p-3  bg-header text-dark">
                    <div style="display: flex;">
                        ...
                        <div style="margin-left: 8%; margin-top: 0%;">
                            <h1 class="text-center">Queenzend Credential Manager</h1>
                        ...
                        <div class="links grid gap-3" style="margin-left: 18%; margin-top: 1%; display: flex; height: 49px;">
                            <div class="input-group-text "><b><i class="bi bi-person-circle"> </i>Queenzend</b></div>
        ...
        <div style="width: 100%;">
            ...
            <ul class="nav nav-pills my-3 " id="pills-tab " role="tablist" style="margin-left: 2%;">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link active " style="color: black;" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-apps" type="button" role="tab" aria-controls="pills-apps" aria-selected="true">
                ...
                <div class="tab-pane fade show active" id="pills-apps" role="tabpanel" aria-labelledby="pills-apps-tab" tabindex="0">
                    <div class="card mb-3 p-2 g-col-3" style="margin: 1.5rem;">
                        <div class="card-header text-white bg-info" style="display: flex;">Apps
                            <div style="margin-left: 88%;"><button style="width: 5rem; border: none; border-radius: 2rem;"><a style="text-decoration: none !important; color: black" href="q_app_form.php"><b><i class="bi bi-person-fill-add"></i> Add</b></a></button></div>
                        </div>
                        <div class=" ">
                    ...
                    <td>
                        ...
                        <button data-bs-toggle="tooltip" title="View" data-bs-placement="top" type="button" style="border: none; background: unset !important;" class="view_record_btn" data-id="' . $id . '" data-bs-toggle="modal" data-bs-target="#myModal' . $id . '">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Queenzend Credential Manager</h4>
                ...
                <div class="tab-pane fade" id="pills-websites" role="tabpanel" aria-labelledby="pills-websites-tab" tabindex="0">
                    <div class="card mb-3 p-2 g-col-6" style="margin: 1.5rem;">
                        <div class="card-header text-white bg-info" style="display: flex;">Websites
                            <div style="margin-left: 85%;"><button style="width: 5rem; border: none; border-radius: 2rem;"><a style="text-decoration: none !important; color: black" href="q_web_form.php"><b><i class="bi bi-person-fill-add"></i> Add</b></a></button></div>
                        </div>
                        <div class=" ">
                ...
                <div class="tab-pane fade " id="pills-admin-details" role="tabpanel" aria-labelledby="pills-admin-details-tab" tabindex="0">
                    <div class="card mb-3 p-2 g-col-6" style="margin: 1.5rem;">
                        <div class="card-header text-white bg-info" style="display: flex;">Admin Details
                            <div style="margin-left: 82%;"><button style="width: 5rem; border: none; border-radius: 2rem;"><a style="text-decoration: none !important; color: black" href="q_admin_form.php"><b><i class="bi bi-person-fill-add"></i> Add</b></a></button></div>
                        </div>
                        <div class=" ">
                ...
                <div class="tab-pane fade " id="pills-server-information" role="tabpanel" aria-labelledby="pills-server-information-tab" tabindex="0">
                    <div class="card mb-3 p-2 g-col-6" style="margin: 1.5rem;">
                        <div class="card-header text-white bg-info" style="display: flex;">Server Information
                            <div style="margin-left: 78%;"><button style="width: 5rem; border: none; border-radius: 2rem;"><a style="text-decoration: none !important; color: black" href="q_server_form.php"><b><i class="bi bi-person-fill-add"></i> Add</b></a></button></div>
                        </div>
                        <div class=" ">
...
<script>
    $(document).ready(function() {
        $('.view_record_btn').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.confirm_del2_btn').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            console.log(id);
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.confirm_del1_btn').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            console.log(id);
...
<script>
    $(document).ready(function() {
        $('.view_record_btn1').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            console.log('Fetching details for ID: ' + id);

            $.ajax({
                url: "q_admin_view.php",
                type: 'POST',
                data: {
                    id: id
                },
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.confirm_del3_btn').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            console.log(id);
...
<script>
    $(document).ready(function() {
        $('.view_record_btn3').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            console.log('Fetching details for ID: ' + id);

            $.ajax({
                url: "q_server_view.php",
                type: 'POST',
                data: {
                    id: id
                },
