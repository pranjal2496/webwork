    ...
    <div style="height: 93vh;">
        ...
        <div class="queen container ">
            <div class="form-content">
                <!-- form section -->
                <h4 style="border-bottom: 0.2px solid #c9d9ea; color: #0e0e0e;  padding-bottom: 16px; margin-bottom: 30px;">Update App</h4>
                <form id="dataForm" action="q_app_update.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-3">
                        ...
                        <div class="row " style="margin-top: 4px;">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="link" class="form-control" style="border-color: grey;" style="width: 100%;" name="link"
                                    value="<?php echo $link; ?>">
                            </div>
                        </div>
