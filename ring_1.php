...
<body>
    ...
    <header>
        <div class="col-12">
            <div class="card-header  bg-white text-dark" style="width: 100%;">

                <div class="p-3 bg-header text-dark">
                    <div style="display: flex;">
                        <img src="Image/queenzendlogo.png" style="width: 140px; margin-left: 6%;">
                        ...
                        <div class="links grid gap-3" style="margin-left: 29%; margin-top: 1%; display: flex; height: 49px;">
    ...
    <div style="display:flex">
        ...
        <div style="height: 100%;"> <?php include('sidebar.php'); ?></div>
        <div style="width: 100%;">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-apps" role="tabpanel" aria-labelledby="pills-apps-tab" tabindex="0">
                    <div class="card mb-3 p-2 g-col-3" style="margin: 1.5rem;">
                        <div class="card-header  p-2 bg-green text-white" style="display: flex;">Apps
                            <div style="margin-left: 88%;"><button style="width: 5rem; border: none; border-radius: 2rem;"><a style="text-decoration: none !important; color: black" href="r_app_form.php"><b><i class="bi bi-person-fill-add"></i> Add</b></a></button></div>
                        </div>
                   ...
                   <td><b>' .$index. '</b></td>
                    ...
                    <td>
                        ...
                        <button data-bs-toggle="tooltip" title="Edit" data-bs-placement="top" style="border: none; text-decoration: none; background: unset !important;">
                            <a class="button-a p-2 g-col-6" href="r_app_edit.php?r_app_editid=' . $id . '"><i class="bi bi-pencil-fill"></i></a>
                        </button>

                        <button data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" type="button" class="confirm_del_btn8" data-id="' . $id . '" style="border: none; background: unset !important;">
                            <a class="button-a p-2 g-col-6" href="#"><i class="bi bi-trash-fill"></i></a>
                        </button>

                        <button data-bs-toggle="tooltip" title="View" data-bs-placement="top" type="button" style="border: none; background: unset !important;" class="view_record_btn8" data-id="' . $id . '" data-bs-toggle="modal" data-bs-target="#myModal' . $id . '">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Ring Credential Manager</h4>
                ...
                <div class="tab-pane fade" id="pills-websites" role="tabpanel" aria-labelledby="pills-websites-tab" tabindex="0">
                    <div class="card mb-3 p-2 g-col-6" style="margin: 1.5rem;">
                        <div class="card-header p-2 bg-green text-white" style="display: flex;">Websites
                            <div style="margin-left: 85%;"><button style="width: 5rem; border: none; border-radius: 2rem;"><a style="text-decoration: none !important; color: black" href="r_web_form.php"><b><i class="bi bi-person-fill-add"></i> Add</b></a></button></div>
                        </div>
                        <div class=" ">
                    ...
                    <td>
                        ...
                        <button data-bs-toggle="tooltip" title="Edit" data-bs-placement="top" style="border: none; text-decoration: none; background: unset !important;">
                            <a class="button-a p-2 g-col-6" href="r_web_edit.php?r_web_editid=' . $id . '"><i class="bi bi-pencil-fill"></i></a>
                        </button>

                        <button data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" type="button" class="confirm_del_btn9" data-id="' . $id . '" style="border: none; background: unset !important;">
                            <a class=" button-a p-2 g-col-6" href="#"><i class="bi bi-trash-fill"></i></a>
                        </button>

                        <button data-bs-toggle="tooltip" title="View" data-bs-placement="top" type="button" style="border: none; background: unset !important;" class="view_record_btn9" data-id="' . $id . '" data-bs-toggle="modal" data-bs-target="#myModal' . $id . '">
                        <a class="button-a p-2 g-col-6" href="#"><i class="bi bi-eye-fill"></i></a>
                          </button>
                ...
                <div class="tab-pane fade " id="pills-admin-details" role="tabpanel" aria-labelledby="pills-admin-details-tab" tabindex="0">
                    <div class="card mb-3 p-2 g-col-6" style="margin: 1.5rem;">
                        <div class="card-header p-2 bg-green text-white" style="display: flex;">Admin Details
                            <div style="margin-left: 82%;"><button style="width: 5rem; border: none; border-radius: 2rem;"><a style="text-decoration: none !important; color: black" href="r_admin_form.php"><b><i class="bi bi-person-fill-add"></i> Add</b></a></button></div>
                        </div>
                        <div class=" ">
                  ...
                  <td><b>' . $index . '</b></td>
                    ...
                    <td>
                        ...
                        <button data-bs-toggle="tooltip" title="Edit" data-bs-placement="top" style="border: none; text-decoration: none; background: unset !important;">
                            <a class="button-a p-2 g-col-6" href="r_admin_edit.php?r_admin_editid=' . $id . '"><i class="bi bi-pencil-fill"></i></a>
                        </button>

                        <button data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" type="button" class="confirm_del_btn10" data-id="' . $id . '" style="border: none; background: unset !important;">
                            <a class="button-a p-2 g-col-6" href="#"><i class="bi bi-trash-fill"></i></a>
                        </button>

                        <button data-bs-toggle="tooltip" title="View" data-bs-placement="top" type="button" style="border: none; background: unset !important;" class="view_record_btn10" data-id="' . $id . '" data-bs-toggle="modal" data-bs-target="#myModal' . $id . '">
                        <a class="button-a p-2 g-col-6" href="#"><i class="bi bi-eye-fill"></i></a>
                          </button>
                ...
                <div class="tab-pane fade " id="pills-server-information" role="tabpanel" aria-labelledby="pills-server-information-tab" tabindex="0">
                    <div class="card mb-3 p-2 g-col-6" style="margin: 1.5rem;">
                        <div class="card-header p-2 bg-green text-white" style="display: flex;">Server Information
                            <div style="margin-left: 78%;"><button style="width: 5rem; border: none; border-radius: 2rem;"><a style="text-decoration: none !important; color: black" href="r_server_form.php"><b><i class="bi bi-person-fill-add"></i> Add</b></a></button></div>
                        </div>
                        <div class=" ">
                  ...
                  <td><b>' . $index . '</b></td>
                    ...
                    <td>
                        ...
                        <button data-bs-toggle="tooltip" title="Edit" data-bs-placement="top" style="border: none; text-decoration: none; background: unset !important;">
                            <a class="button-a p-2 g-col-6" href="r_server_edit.php?r_server_editid=' . $id . '"><i class="bi bi-pencil-fill"></i></a>
                        </button>

                        <button data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" type="button" class="confirm_del_btn11" data-id="' . $id . '" style="border: none; background: unset !important;">
                            <a class="button-a p-2 g-col-6" href="#"><i class="bi bi-trash-fill"></i></a>
                        </button>

                        <button data-bs-toggle="tooltip" title="View" data-bs-placement="top" type="button" style="border: none; background: unset !important;" class="view_record_btn11" data-id="' . $id . '" data-bs-toggle="modal" data-bs-target="#myModal' . $id . '">
                        <a class="button-a p-2 g-col-6" href="#"><i class="bi bi-eye-fill"></i></a>
                          </button>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.confirm_del_btn8').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            console.log(id);
...
<script>
    $(document).ready(function() {
        $('.view_record_btn8').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.confirm_del_btn9').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            console.log(id);
...
<script>
    $(document).ready(function() {
        $('.view_record_btn9').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            console.log('Fetching details for ID: ' + id);
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.confirm_del_btn10').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            console.log(id);
...
<script>
    $(document).ready(function() {
        $('.view_record_btn10').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            console.log('Fetching details for ID: ' + id);

            $.ajax({
                url: "r_admin_view.php",
                type: 'POST',
                data: {
                    id: id
                },
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.confirm_del_btn11').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            console.log(id);
...
<script>
    $(document).ready(function() {
        $('.view_record_btn11').click(function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            console.log('Fetching details for ID: ' + id);

            $.ajax({
                url: "r_server_view.php",
                type: 'POST',
                data: {
                    id: id
                },
