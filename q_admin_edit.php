...
$id = $_GET['q_admin_editid'];

$sql = "SELECT * FROM `registration_2` WHERE id= $id";
    ...
    <div style="height: 93vh;">
        ...
        <div class="queen container ">
            <div class="form-content">
                <!-- form section -->
                <h4 style="border-bottom: 0.2px solid #c9d9ea; color: #0e0e0e;  padding-bottom: 16px; margin-bottom: 30px;">Update Admin Details</h4>
                <form id="dataForm" action="q_admin_update.php" method="POST" enctype="multipart/form-data">
